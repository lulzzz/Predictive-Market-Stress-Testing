...
$('.run-analysis.Button').click(function(){
        ...
        if(formPortfolio.includes('Loading...')) {
          ...
          Process(formPortfolio, formRiskFactor, formShockMag, formRiseFall, function(){
          });
        }
});

//create the output tables
function Process(formPortfolio, formRiskFactor, formShockMag, formRiseFall) {
      ...
      success: function(data) {
          ...
          today = mm+'/'+dd+'/'+yyyy;
          console.log(today);
          $('.pl-table__header div a').text(today);
          ...
          var tf = "";
          tf += "<tr tabindex='0' aria-label=Portfolio Table><td><strong>Portfolio Total</strong></td><td></td><td></td><td>" + SumCurrent  +  " " + BaseVal_Array[1] +"</td><td align='left'>" + SumStressed + " " + NewVal_Array[1] + "</td><td>" + totalPL +"%</td></tr>";
